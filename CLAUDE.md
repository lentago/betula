...
The Loki output is independent of the HTTP output — either path runs alone. The optional Loki receiver in our homelab is the Alloy container in [lentago/drosera](https://github.com/lentago/drosera); other consumers (Promtail, Vector, a self-hosted Loki) work too.
